...
/*
 ...
 output array: ["a", "b"]
 */
func convertOptionalArrayIntoNonOptional(_ arrayWithOptionals: [String?]) -> [String] {
    var arrayWithoutOptionals : [String] = []
    for element in arrayWithOptionals {
        if let element = element {
            arrayWithoutOptionals.append(element)
        }
    }
    return arrayWithoutOptionals
}

convertOptionalArrayIntoNonOptional(["a", nil, "b"])
/*:
 +2.
 ...
 */
func sortElementsOfArrayByAge (mutableArray: inout [Int]) -> [Int] {
    var swap = false
...
var initialArray = [4,7,9,3,1]
sortElementsOfArrayByAge(mutableArray: &initialArray)
 ...
 */
let soldatsAndGreeting = ["Иванов": "Привет, я Иванов",
                          "Cидоров": "Привет, я Сидоров",
                          "Петров": "Привет, я Петров"]
for key in soldatsAndGreeting.keys {
    print(key)
}
for value in soldatsAndGreeting.values {
    print(value)
}
for key in soldatsAndGreeting.keys {
    if key == "Иванов" {
